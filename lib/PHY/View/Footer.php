                ...
                foreach (array_keys($_files) as $type) {
                    foreach ($_files[$type] as $file) {
                        if (is_array($file) || is_object($file)) {
                            ...
                            $source = false;
                            foreach ($path->getPaths('public' . DIRECTORY_SEPARATOR . 'resource' . DIRECTORY_SEPARATOR . $theme . DIRECTORY_SEPARATOR . $type . DIRECTORY_SEPARATOR . str_replace('/', DIRECTORY_SEPARATOR, $sourceFile), 'public' . DIRECTORY_SEPARATOR . 'resource' . DIRECTORY_SEPARATOR . 'default' . DIRECTORY_SEPARATOR . $type . DIRECTORY_SEPARATOR . str_replace('/', DIRECTORY_SEPARATOR, $sourceFile)) as $_source) {
                                if (is_file($_source)) {
                                    $source = $_source;
                                    break;
                                }
